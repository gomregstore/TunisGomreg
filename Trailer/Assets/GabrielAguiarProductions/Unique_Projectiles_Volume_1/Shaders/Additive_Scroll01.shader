...
////// Emissive:
                ...
                float3 emissive = (((_DistortionMask_copy.rgb*_MainTexutre_var.rgb)*i.vertexColor.rgb*(_ColorMultiplier*_TintColor.rgb*_ColorRamp_var.rgb)*2.0*(_MainTexutre_var.a*pow(_Gradient_var.r,_GradientPower)*clamp(isFrontFace,_DoubleSided,1.0)))*saturate((sceneZ-partZ)/_EdgeSoftness));
